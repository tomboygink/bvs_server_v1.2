            ...
            switch (_b.label) {
                case 0:
                    ...
                    switch (_a) {
                        ...
                        case 'set_DevsGroups': return [3, 32];
                        case 'set_UpdateDevsGroups': return [3, 34];
                        case 'get_SchemeSvg': return [3, 36];
                        case 'set_SchemeSvg': return [3, 38];
                        case 'get_Devs': return [3, 40];
                        case 'set_Devs': return [3, 42];
                        case 'set_ChangeDevs': return [3, 44];
                        case 'get_LastDevSess': return [3, 46];
                        case 'set_ControlDevSess': return [3, 48];
                        case 'set_deleteControlDevSess': return [3, 50];
                        case 'get_ControlDevSess': return [3, 52];
                        case 'get_DevSess': return [3, 54];
                        case 'set_DevVerif': return [3, 56];
                        case 'get_DevVerif': return [3, 58];
                        case 'set_ThermalWell': return [3, 60];
                        case 'set_ChangeThermalWell': return [3, 62];
                        case 'get_ThermalWell': return [3, 64];
