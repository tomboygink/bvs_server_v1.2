...
var User = (function () {
    ...
    User.prototype.deleteSessionCode = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.db.query("DELETE FROM sessions WHERE sess_code = '" + this.sess_code + "'")];
                    case 1:
                        _a.sent();
                        return [2];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        db_response = _a.sent();
                        if (!(db_response.rows[0].re_password_code === this.args.code)) return [3, 3];
                        return [4, this.db.query("UPDATE users SET re_password_code = '" +
                                re_pass_code +
                                "', password = '" +
                                pass +
                                "' WHERE login = '" +
    ...
    User.prototype.changePass = function () {
        return __awaiter(this, void 0, void 0, function () {
            var db_response, old_pass, new_pass, re_pass_code;
            return __generator(this, function (_a) {
                switch (_a.label) {
