...
exports.DevVerif = exports.DevVerifEntity = void 0;
var DBase_1 = require("./DBase");
var DateStr_1 = require("./DateStr");
var DevVerifEntity = (function () {
    function DevVerifEntity() {
        this.id = 0;
        this.dev_id = 0;
        this.dev_number = "";
        this.start_povs = new Date(Date.now());
        this.end_povs = new Date(Date.now());
        this.old_dev_povs = 0;
    }
    return DevVerifEntity;
}());
exports.DevVerifEntity = DevVerifEntity;
var DevVerif = (function () {
    function DevVerif(_args, _sess_code) {
        this.db = (0, DBase_1.getDB)();
        this.args = _args;
        this.sess_code = _sess_code;
    }
    DevVerif.prototype.insertDevVerif = function () {
...
//# sourceMappingURL=DevVerif.js.map