...
exports.ParcingNewData = void 0;
var DBase_1 = require("../config/xcore/dbase/DBase");
var DateStr_1 = require("../config/xcore/dbase/DateStr");
var fs = __importStar(require("fs"));
var path = __importStar(require("path"));
var ParcingNewData = (function () {
    function ParcingNewData(_data_str, _s_ind) {
        this.data_str = _data_str;
        this.s_ind = _s_ind;
        this.data_arr = [];
        this.db = (0, DBase_1.getDB)();
    }
    ParcingNewData.prototype.Run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var logsPath, month, fileName, time_log, dt_arr_0, d, TIME, NUMBER, NUMBER_I, ERROR, ERROR_I, AKB, AKB_I, SENSORS, SENSORS_I, d, error, info_err, query_devs, srv_time, obj, s, i, sess_data_sql, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 10, , 11]);
                        console.log("Парсинг данных новой прошивки");
                    ...
                    case 5:
                        ...
                        return [4, this.db.query("INSERT INTO dev_sess (time_dev, time_srv, dev_number, dev_id, level_akb, sess_data, err) VALUES ('" +
    ...
    return ParcingNewData;
}());
exports.ParcingNewData = ParcingNewData;
//# sourceMappingURL=parcing_new_data.js.map